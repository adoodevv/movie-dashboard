      ...
      <div className="home-movies mx-12">
         ...
         {featuredMovie && (
            <div className="relative">
               <img
                  src={`https://image.tmdb.org/t/p/w1280${featuredMovie.backdrop_path}`} // Use backdrop_path instead of poster_path
               ...
               <div className="absolute bottom-0 left-0 p-4">
                  ...
                  <div className="flex mt-2">
                     ...
                     <p className="text-white ml-4">%{featuredMovie.vote_average * 10} Match</p>
                  </div>
         ...
         <div className="upcoming-movies mt-8">
