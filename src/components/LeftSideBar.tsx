...
const LeftSideBar: React.FC = () => {
   return (
      <div className="left-sidebar ml-4 md:ml-12 py-4">
         <div className="flex items-center text-lg md:text-xl font-bold mt-2 md:mt-4 mb-4 md:mb-8">
            <h1 className="">
         ...
         <div className="menu-header mb-4">
            ...
            <ul>
               <li className="flex items-center py-2 md:py-3 px-2 md:px-4 relative">
               ...
               <li className="flex items-center py-2 md:py-3 px-2 md:px-4">
